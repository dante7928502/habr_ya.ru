...
class YandexSeacrhLocators:
    ...
    LOCATOR_YANDEX_POPUP_OVERLAY_CLOSE_BTN = (
        By.CLASS_NAME,
        "DistributionButtonClose",
    )
    LOCATOR_YANDEX_NAVIGATION_BAR = (By.CLASS_NAME, "HeaderNav-Tab")
...
class SearchHelper(BasePage):
    ...
    def close_popup_overlay(self):
        return self.find_element(
            YandexSeacrhLocators.LOCATOR_YANDEX_POPUP_OVERLAY_CLOSE_BTN
        ).click()
    ...
    def click_on_the_search_button(self):
        return self.find_element(
            YandexSeacrhLocators.LOCATOR_YANDEX_SEARCH_BUTTON, time=2
        ).click()
